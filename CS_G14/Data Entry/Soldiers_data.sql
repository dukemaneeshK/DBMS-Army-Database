...
INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (36099,'Rajesh Kumar panth','Havildar','2005-07-02','23rd Infantry Division',189512,173,70,81,1,'2040-10-11','1985-3-11', 2005);


INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (12345, 'Bishan Singh Bedi', ' Lieutenant', '1960-08-12', '82nd Airborne Divison', '991955', 152, 48, 77, 1, '1975-10-01','1940-04-12', 1960);

INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (17694, 'Harminder Kaur', 'Field Marshal', '1992-7-21', '82nd Airborne Divison', '640565', 165, 45, 78, 0, '23-8-2018','1-1-1974', 1960);
...
INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (28613,'Hamid Ahmed Qureshi','Soldier','2008-02-24','23rd Infantry Division',776890,169,70,78,1,'2036-04-02','1988-06-12', 2005);


INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (27989,'Rakshit Jain','Major','2013-08-06','39th Infantry Division',671365,170,66,76,1,'2040-06-10','1990-02-13', 2013);



INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (14256,'Subham Singh','Captain','2010-05-04','4th Infantry Division',454690,176,80,85,1,'2055-02-01','1988-06-12', 2010);


INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (48563,'Ajay Singh Kumnawat','Colonel','2003-07-08','41st Artillery Division',490993,178,80,84,1,'2043-05-18','1980-03-22', 2003);

INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (33728,'Sandeep Singh','Brigadier','2009-5-17','39th Infantry Division',126239,169,71,74,1,'2051-5-18','1988-4-21', 2013);


INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (11053,'Avantika Kulkarni','Soldier','2012-4-26','25th RAPID',928032,158,58,76,0,'2058-6-21','1990-5-16', 2008);


INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (23432,'Abhishek Saxena','Soldier','2005-5-12','4th Armoured Division',307820,176,72,78,1,'2049-3-21','1985-5-16', 2005);


INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (22513,'Rajveer Singh','Captain','2010-2-15','475th Engineering Brigade',761137,184,82,84,1,'2054-1-18','1988-2-15', 2010);


INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (40386,'Vijay Singh Rajput','Soldier','2012-4-19','34th Mountain Division',618987,176,72,78,1,'2058-3-9','1989-3-24', 2011);



INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (31931,'Satyam Singh Rathore','Soldier','2010-3-17','34th Mountain Division',623846,182,78,84,1,'2053-3-23','1986-4-12', 2011);


INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (19339,'Arjun Pratap','Soldier','2012-4-15','4th Armoured Division',144790,176,70,74,1,'2059-8-20','1987-5-23', 2005);


INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (33998,'Karan Jagtap','Soldier','2008-5-16','25th RAPID',167009,179,76,74,1,'2049-4-21','1982-5-23', 2008);



INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (13423,'Jaspreet Singh Kaur','Soldier','2010-9-24','7th Infantry Division',727545,182,75,80,1,'2054-4-17','1985-9-9', 2010);


INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (49159,'Vijay Kumar Ahirwar','Major General','2011-3-15','34th Mountain Division',591813,176,70,76,1,'2009-3-21','1983-4-27', 2011);


INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (29603,'Maneesh Kumar Yadav','Soldier','2005-6-21','50th Independent Parachute Brigade',543801,182,76,80,1,'2012-5-17','1987-8-24', 2013);


INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (21474,'Brijmohan Singh','Field Marshal','2010-12-21','39th Infantry Division',454981,172,80,75,1,'2050-5-17','1990-12-24', 2013);

INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (12498,'Rajat Talesra','General','2008-12-4','50th Independent Parachute Brigade',715244,177,79,80,1,'2048-12-10','1995-01-13', 2013);


INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (14298,'Niranjan Arya','Lieutenant General','2014-5-14','23rd Infantry Division',340320,158,82,74,0,'2054-02-01','1996-11-12', 2005);


INSERT INTO "soldier" (ID, name_, rank, doj, squadno, birthplacepincode, height, weight, chest, Sex, dor, DOB, yearNo) VALUES
  (10923,'Sonam Kumari','Major General','2001-05-25','82nd Airborne Divison',266559,171,48,72,1,'2041-02-01','1990-10-2', 1960);
